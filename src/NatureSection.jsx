...
const stats = [
  { value: "3.2B", label: "Trees planted globally", icon: "🌳" },
  { value: "40%",  label: "Carbon offset achieved", icon: "💨" },
  { value: "180+", label: "Species protected",       icon: "🦋" },
];
      ...
      >
        ...
        <div style={{ position:"relative",zIndex:2,maxWidth:880,width:"100%",textAlign:"center" }}>
          ...
          <h2 style={{
            ...
            We care for{" "}
            <em style={{ color:"#7ec89a",fontStyle:"italic" }}>nature</em>,<br/>
            and we nurture it.
          </h2>
          ...
          <p style={{
            ...
            Every decision we make, every product we build, and every initiative
            we launch is guided by one unshakeable belief — the natural world
            deserves more than words. It deserves action.
          </p>
